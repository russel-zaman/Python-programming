...
# Finally a Hand class that holds those Cards that have been dealt to each player from the Deck.
...
class Hand:
    ...
    def adjust_for_ace(self):   # Aces issue: If a hand's value exceeds 21 but it contains an Ace, we can reduce the Ace's value from 11 to 1 and continue playing.
